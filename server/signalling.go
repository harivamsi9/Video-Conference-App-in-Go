...
func JoinRoomRequestHandler(w http.ResponseWriter, r *http.Request) {
	...
	// fmt.Fprintf(w, "Hello World Join")
...
// WelcomePageRequestHandler will Welcome Home Landing Page
func WelcomePageRequestHandler(w http.ResponseWriter, r *http.Request) {
	// w.Write("TESTJOIN")
	// return nil

	fmt.Fprintf(w, "Welcome to the next level Of Zoom")
}
